...
public class swingtest {
	...
	private void initialize() {
		...
		username.setBounds(31, 52, 37, 21);
		busMyinfo.add(username);
		
		usermoney = new JTextPane();
		usermoney.setBounds(50, 185, 224, 21);
		busMyinfo.add(usermoney);

		JLabel lblNewLabel_2_1 = new JLabel("");
		lblNewLabel_2_1.setIcon(new ImageIcon("C:\\Users\\admin\\Desktop\\bus-image\\busMyInfo2.png"));
		...
		BtnMyinfo.setBounds(12, 10, 45, 24);
		...
		btnNewButton_1_2.setBounds(124, 425, 97, 112);
		bus_login.add(btnNewButton_1_2);

		JButton btnNewButton_1_1 = new JButton("");
		btnNewButton_1_1.setFocusPainted(false);
		btnNewButton_1_1.setContentAreaFilled(false);
		btnNewButton_1_1.setBorderPainted(false);
		btnNewButton_1_1.setBounds(124, 277, 97, 112);
		bus_login.add(btnNewButton_1_1);

		JButton btnNewButton_1 = new JButton("");
		btnNewButton_1.setFocusPainted(false);
		btnNewButton_1.setContentAreaFilled(false);
		btnNewButton_1.setBorderPainted(false);
		btnNewButton_1.setBounds(122, 133, 97, 112);
		bus_login.add(btnNewButton_1);

		JLabel lblNewLabel_8 = new JLabel("New label");
		lblNewLabel_8.setIcon(new ImageIcon("C:\\Users\\admin\\Desktop\\bus-image\\busMain.png"));
		lblNewLabel_8.setBounds(-9, -10, 370, 630);
	...
	public void login() throws SQLException {
		...
		for (int i = 0; i < userList.length; i++) {
			...
			if (userList[i].userid != null) {
				if (userList[i].userid.equals(login_id.getText()) && userList[i].password.equals(login_pass.getText())) {
